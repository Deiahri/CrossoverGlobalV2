...
import {
  RiSparkling2Line, RiMapPin2Line, RiToolsLine,
  RiBuildingLine, RiWaterFlashLine, RiPlantLine,
  RiGroupLine, RiHandHeartLine,
} from 'react-icons/ri'
          ...
          <section aria-labelledby="active-heading">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {active.map((project, i) => (
                <Reveal key={project.slug} variant="fadeUp" delay={i * 70}>
                  <ProjectCard {...project} />
                </Reveal>
              ))}
            </div>
